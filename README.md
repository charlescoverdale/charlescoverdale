...
| [**magentabook**](https://github.com/charlescoverdale/magentabook) | HM Treasury Magenta Book policy evaluation primitives | [![CRAN](https://www.r-pkg.org/badges/version/magentabook)](https://CRAN.R-project.org/package=magentabook) | [![Downloads](https://cranlogs.r-pkg.org/badges/magentabook)](https://CRAN.R-project.org/package=magentabook) |
...
| [**ivcheck**](https://github.com/charlescoverdale/ivcheck) | Instrumental variable validity tests | [![CRAN](https://www.r-pkg.org/badges/version/ivcheck)](https://CRAN.R-project.org/package=ivcheck) | [![Downloads](https://cranlogs.r-pkg.org/badges/ivcheck)](https://CRAN.R-project.org/package=ivcheck) |
